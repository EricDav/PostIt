...
group.delete('/api/v1/groups/:groupId/delete',
  auth, groupValidator.deleteGroupValidation, groupInfo.deleteGroup);
...
group.post('/api/v1/groups/:groupId/user', auth,
  ...
  groupValidator.userValidation, groupInfo.addUser);

group.post('/api/v1/group', auth,
  groupValidator.groupNullValidation, groupInfo.create);

group.post('/api/v1/groups/:groupId/message',
  auth, groupValidator.groupValidation);

group.put('/api/v1/groups/:groupId/update',
  auth, groupValidator.groupNullValidation,
  groupInfo.updateGroupInfo);

group.get('/api/v1/groups/:groupId/members',
  auth, groupValidator.groupValidation,

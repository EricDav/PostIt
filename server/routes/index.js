...
app.post('/api/v1/group/:groupId/message', auth, groupValidator.groupValidation, groupMessagesController.createMessage);
...
app.get('/api/v1/userMessages', auth, userController.userMessages);

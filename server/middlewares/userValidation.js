import { isDigit, isText, isInValidField } from '../helpers/index';
...
const userValidation = {
  basicValidation(req, res, next) {
    ...
    if (isInValidField(req.body.phoneNumber)) {
      error.phoneNumber = 'This field is required';
      canVerify.phoneNumber = false;
    }
    ...
    if (canVerify.phoneNumber && (!isDigit(req.body.phoneNumber) ||

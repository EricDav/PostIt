...
import { setPiority } from '../../actions/setPiority';
...
class Piority extends React.Component {
    ...
    render() {
        ...
        <form action="#" id="pform">
            <p id="piority">
                <input onClick={this.onClick} value="normal" name="group1" type="radio" id="test1" />
      <label htmlFor="test1">Normal</label>
    </p>
    <p id="piority">
      <input onClick={this.onClick} value="urgent"  name="group1" type="radio" id="test2" />
      <label htmlFor="test2">Urgent</label>
    </p>
    <p id="piority">
      <input onClick={this.onClick} className="with-gap" name="group1" type="radio" id="test3"  value="critical" />

        ...
        return (
          <div key={message.message.id}>
            ...
            <Messages name={message.message.senderUsername}
              ...
              viewers={message.viewers} date={message.message.createdAt}/>
          </div>
        )
      } else {
        return (
          <Messages name={message.message.senderUsername}
            ...
            content={message.message.content}
            viewers={message.viewers} d
            ate={message.message.createdAt}/>
        );
      }
    });
  }
        ...
        <div className="collection-item avatar">
          <p className="email-subject truncate">
            <span className="email-tag grey lighten-3">
              ...
              <GroupButton text={"ADD MEMBERS"}/>}
              { this.props.currentGroup.id &&
              <GroupButton text={"VIEW MEMBERS"} 
                setRightNavBarView={this.props.setRightNavBarView}/>}</span>
          </p>
        </div>

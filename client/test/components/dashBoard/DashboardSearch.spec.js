...
describe('DashboardSearch Component', () => {
  it('should render DashboardSearch component', () => {
    ...
    expect(wrapper.node.props.children.props.children[0].type)
      .toEqual('input');
    expect(wrapper.node.props.children.props.children[0].props.id)
      .toEqual('search');
    expect(wrapper.node.props.children.props.children[0].props.placeholder)
      .toEqual('search for users');

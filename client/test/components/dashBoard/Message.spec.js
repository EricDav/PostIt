...
import { Message, mapStateToProps }
  from '../../../components/dashboard/Message.jsx';
...
describe('Message Component', () => {
  ...
  it('should render Message component', () => {
    ...
    expect(wrapper.node.props.className)
      .toEqual('collection-item avatar listMessage');
    expect(wrapper.node.type).toEqual('li');
    expect(wrapper.node.props.children[0].props.className)
      .toEqual('circle indigo darken-1');
  });
});
